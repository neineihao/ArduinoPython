...
BM1422GMV::BM1422GMV(PinName sda, PinName scl, uint8_t addr = BM1422GMV_DEVICE_ADDRESS_L) : Sensor(sda, scl){
  _address = addr;
}

//Initialization function
BM1422GMV::init(uint8_t mode = BM1422GMV_MODE_SINGLE, uint8_t rate = BM1422GMV_OUTPUT_RATE_20_HZ, uint8_t output = BM1422GMV_OUTPUT_14_BIT, uint8_t avg = BM1422GMV_AVERAGE_4) {
